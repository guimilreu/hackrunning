...
const STEPS = [
  { path: '/onboarding/step1', stepNumber: 1, label: 'Perfil', icon: User },
  { path: '/onboarding/step2', stepNumber: 2, label: 'Objetivos', icon: Target },
  { path: '/onboarding/step3', stepNumber: 3, label: 'Métricas', icon: Ruler },
  { path: '/onboarding/step4', stepNumber: 4, label: 'Saúde', icon: Heart },
  { path: '/onboarding/step5', stepNumber: 5, label: 'Histórico', icon: Activity },
  { path: '/onboarding/step6', stepNumber: 6, label: 'Testes', icon: Timer },
  { path: '/onboarding/kickstart-kit', stepNumber: 7, label: 'Kit', icon: Gift },
];
